...
@echo off
rem    %xslproc1% test.xml CID2UANodeset.xsl -o UANodeset.xml
rem    %xslproc2% test.xml CID2UANodeset.xsl > output_msxsl.xml
    %xslproc3% ABB40BUS20120712_sav_40B_EQ.xml CIM2UANodeset2.xsl IEC_61970_UANodeset2.xml
