	...
	<xsl:template match="/">
		<UANodeSet xmlns="http://opcfoundation.org/UA/2011/03/UANodeSet.xsd" 
			...
			<xsl:attribute name="xsi:schemaLocation" 
                     ...
                     select="'http://opcfoundation.org/UA/2011/03/UANodeSet.xsd C:/Users/Administrator/Desktop/John/UANodeSet.xsd'"/>
...
<!-- *************************** -->
      ...
      <xsl:for-each select="rdf:RDF/cim:Season">
        <UAObject>
          ...
          <xsl:attribute name="BrowseName" namespace="" select="fn:concat('2:',fn:string(cim:Season.name/@rdf:resource))"/>
          <DisplayName>
          ...
          <References>
            <Reference ReferenceType="Organizes" IsForward="false">ns=2;s=Ses</Reference>
            <Reference ReferenceType="HasTypeDefinition" IsForward="true">ns=2;s=Se</Reference>
          </References>
        </UAObject>
      ...
      <xsl:for-each select="rdf:RDF/cim:ConformLoadSchedule">
        <UAObject>
          ...
          <References>
            <Reference ReferenceType="Organizes" IsForward="false">ns=2;s=CLoSs</Reference>
            <Reference ReferenceType="HasTypeDefinition" IsForward="true">ns=2;s=CLoS</Reference>
            <Reference>
              <xsl:attribute	name="ReferenceType">ns=2;s=ConformLoadSchedule.ConformLoadGroup</xsl:attribute>
              <xsl:attribute name="IsForward">true</xsl:attribute>
              <xsl:sequence select="fn:concat('ns=2;s=', fn:substring(cim:ConformLoadSchedule.ConformLoadGroup/@rdf:resource,2,33))"/>
            </Reference>
            <Reference>
              <xsl:attribute	name="ReferenceType">ns=2;s=SeasonDayTypeSchedule.DayType</xsl:attribute>
              <xsl:attribute name="IsForward">true</xsl:attribute>
              <xsl:sequence select="fn:concat('ns=2;s=', fn:substring(cim:SeasonDayTypeSchedule.DayType/@rdf:resource,2,33))"/>
            </Reference>
            <Reference>
              <xsl:attribute	name="ReferenceType">ns=2;s=SeasonDayTypeSchedule.Season</xsl:attribute>
              <xsl:attribute name="IsForward">true</xsl:attribute>
              <xsl:sequence select="fn:concat('ns=2;s=', fn:substring(cim:SeasonDayTypeSchedule.Season/@rdf:resource,2,33))"/>
            </Reference>
          </References>
        </UAObject>
        <xsl:call-template name="CreateVariable">
      ...
      <xsl:for-each select="rdf:RDF/cim:CurveData">
        <UAObject>
          <xsl:attribute name="NodeId" namespace="" select="fn:concat('ns=2;s=', fn:string(@rdf:ID))"/>
          <xsl:attribute name="BrowseName" namespace="" select="fn:concat('2:',fn:string(cim:RegularIntervalSchedule.xvalue))"/>
          <DisplayName>
          ...
          <References>
            <Reference ReferenceType="Organizes" IsForward="false">ns=2;s=CDats</Reference>
            <Reference ReferenceType="HasTypeDefinition" IsForward="true">ns=2;s=CDat</Reference>
            <Reference>
              <xsl:attribute	name="ReferenceType">ns=2;s=CurveData.Curve</xsl:attribute>
              <xsl:attribute name="IsForward">true</xsl:attribute>
              <xsl:sequence select="fn:concat('ns=2;s=', fn:substring(cim:CurveData.Curve/@rdf:resource,2,33))"/>
            </Reference>
          </References>
        </UAObject>
        <xsl:call-template name="CreateVariable">
          <xsl:with-param name="UAVariableId">CDat.xvalue</xsl:with-param>
          <xsl:with-param name="UAVariableName">RegularIntervalSchedule.xvalue</xsl:with-param>
          <xsl:with-param name="UAVariableValue">
            <xsl:value-of select="fn:string(cim:RegularIntervalSchedule.xvalue)"/>
          </xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="CreateVariable">
          <xsl:with-param name="UAVariableId">CDat.y1value</xsl:with-param>
          <xsl:with-param name="UAVariableName">RegularIntervalSchedule.y1value</xsl:with-param>
          <xsl:with-param name="UAVariableValue">
            <xsl:value-of select="fn:string(cim:RegularIntervalSchedule.y1value)"/>
          </xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="CreateVariable">
          <xsl:with-param name="UAVariableId">CDat.y2value</xsl:with-param>
          <xsl:with-param name="UAVariableName">BasicIntervalSchedule.y2value</xsl:with-param>
          <xsl:with-param name="UAVariableValue">
            <xsl:value-of select="fn:string(cim:BasicIntervalSchedule.y2value)"/>
          </xsl:with-param>
        </xsl:call-template>
      </xsl:for-each>
      ...
      <xsl:for-each select="rdf:RDF/cim:LoadArea">
        <UAObject>
          ...
          <References>
            <Reference ReferenceType="Organizes" IsForward="false">ns=2;s=LAs</Reference>
            <Reference ReferenceType="HasTypeDefinition" IsForward="true">ns=2;s=LA</Reference>
          </References>
        </UAObject>
        <xsl:call-template name="CreateVariable">
          <xsl:with-param name="UAVariableId">IDO.aliasName</xsl:with-param>
      ...
      <xsl:for-each select="rdf:RDF/cim:PhaseTapChangerLinear">
        <UAObject>
          ...
          <References>
            <Reference ReferenceType="Organizes" IsForward="false">ns=2;s=PTCLs</Reference>
            <Reference ReferenceType="HasTypeDefinition" IsForward="true">ns=2;s=PTCL</Reference>
            <Reference>
              <xsl:attribute	name="ReferenceType">ns=2;s=TapChanger.TapChangerControl</xsl:attribute>
              <xsl:attribute name="IsForward">true</xsl:attribute>
              <xsl:sequence select="fn:concat('ns=2;s=', fn:substring(cim:TapChanger.TapChangerControl/@rdf:resource,2,33))"/>
            </Reference>
            <Reference>
              <xsl:attribute	name="ReferenceType">ns=2;s=PhaseTapChanger.TransformerEnd</xsl:attribute>
              <xsl:attribute name="IsForward">true</xsl:attribute>
              <xsl:sequence select="fn:concat('ns=2;s=', fn:substring(cim:PhaseTapChanger.TransformerEnd/@rdf:resource,2,33))"/>
            </Reference>
          </References>
        </UAObject>
        <xsl:call-template name="CreateVariable">
      ...
      <xsl:for-each select="rdf:RDF/cim:PhaseTapChangerAsymmetrical">
        <UAObject>
          ...
          <References>
            <Reference ReferenceType="Organizes" IsForward="false">ns=2;s=PTCAs</Reference>
            <Reference ReferenceType="HasTypeDefinition" IsForward="true">ns=2;s=PTCA</Reference>
            <Reference>
              <xsl:attribute	name="ReferenceType">ns=2;s=TapChanger.TapChangerControl</xsl:attribute>
              <xsl:attribute name="IsForward">true</xsl:attribute>
              <xsl:sequence select="fn:concat('ns=2;s=', fn:substring(cim:TapChanger.TapChangerControl/@rdf:resource,2,33))"/>
      ...
      <xsl:for-each select="rdf:RDF/cim:MutualCoupling">
        <UAObject>
          ...
          <References>
            <Reference ReferenceType="Organizes" IsForward="false">ns=2;s=MCs</Reference>
            <Reference ReferenceType="HasTypeDefinition" IsForward="true">ns=2;s=MC</Reference>
            <Reference>
              <xsl:attribute	name="ReferenceType">ns=2;s=MC.First_Terminal</xsl:attribute>
              <xsl:attribute name="IsForward">true</xsl:attribute>
              <xsl:sequence select="fn:concat('ns=2;s=', fn:substring(cim:MutualCoupling.First_Terminal/@rdf:resource,2,33))"/>
            </Reference>
            <Reference>
              <xsl:attribute	name="ReferenceType">ns=2;s=MC.Second_Terminal</xsl:attribute>
              <xsl:attribute name="IsForward">true</xsl:attribute>
              <xsl:sequence select="fn:concat('ns=2;s=', fn:substring(cim:MutualCoupling.Second_Terminal/@rdf:resource,2,33))"/>
            </Reference>
          </References>
        </UAObject>
        <xsl:call-template name="CreateVariable">
      ...
      <xsl:for-each select="rdf:RDF/cim:ConformLoad">
        <UAObject>
          ...
          <References>
            <Reference ReferenceType="Organizes" IsForward="false">ns=2;s=CLos</Reference>
            <Reference ReferenceType="HasTypeDefinition" IsForward="true">ns=2;s=CLo</Reference>
            <Reference>
              <xsl:attribute	name="ReferenceType">ns=2;s=ConformLoad.LoadGroup</xsl:attribute>
              <xsl:attribute name="IsForward">true</xsl:attribute>
              <xsl:sequence select="fn:concat('ns=2;s=', fn:substring(cim:ConformLoad.LoadGroup/@rdf:resource,2,33))"/>
            </Reference>
            <Reference>
              <xsl:attribute	name="ReferenceType">ns=2;s=Equipment.EquipmentContainer</xsl:attribute>
              <xsl:attribute name="IsForward">true</xsl:attribute>
      ...
      <xsl:for-each select="rdf:RDF/cim:ConformLoadGroup">
        <UAObject>
          ...
          <References>
            <Reference ReferenceType="Organizes" IsForward="false">ns=2;s=CLoGs</Reference>
            <Reference ReferenceType="HasTypeDefinition" IsForward="true">ns=2;s=CLoG</Reference>
            <Reference>
              <xsl:attribute	name="ReferenceType">ns=2;s=LoadGroup.SubLoadArea</xsl:attribute>
              <xsl:attribute name="IsForward">true</xsl:attribute>
              <xsl:sequence select="fn:concat('ns=2;s=', fn:substring(cim:LoadGroup.SubLoadArea/@rdf:resource,2,33))"/>
            </Reference>
          </References>
        </UAObject>
        <xsl:call-template name="CreateVariable">
      ...
      <xsl:for-each select="rdf:RDF/cim:NonConformLoad">
        <UAObject>
          ...
          <References>
            <Reference ReferenceType="Organizes" IsForward="false">ns=2;s=NCLos</Reference>
            <Reference ReferenceType="HasTypeDefinition" IsForward="true">ns=2;s=NCLo</Reference>
            <Reference>
              <xsl:attribute	name="ReferenceType">ns=2;s=NonConformLoad.LoadGroup</xsl:attribute>
              <xsl:attribute name="IsForward">true</xsl:attribute>
              <xsl:sequence select="fn:concat('ns=2;s=', fn:substring(cim:NonConformLoad.LoadGroup/@rdf:resource,2,33))"/>
            </Reference>
            <Reference>
              <xsl:attribute	name="ReferenceType">ns=2;s=Equipment.EquipmentContainer</xsl:attribute>
              <xsl:attribute name="IsForward">true</xsl:attribute>
      ...
      <!-- Parse Disconnector Objects-->
        <xsl:for-each select="rdf:RDF/cim:Disconnector">
          <UAObject>
            ...
            <References>
              <Reference ReferenceType="Organizes" IsForward="false">ns=2;s=Diss</Reference>
              <Reference ReferenceType="HasTypeDefinition" IsForward="true">ns=2;s=Dis</Reference>
              <Reference>
                <xsl:attribute	name="ReferenceType">ns=2;s=Equipment.EquipmentContainer</xsl:attribute>
                <xsl:attribute name="IsForward">true</xsl:attribute>
                <xsl:sequence select="fn:concat('ns=2;s=', fn:substring(cim:Equipment.EquipmentContainer/@rdf:resource,2,33))"/>
      ...
      <xsl:for-each select="rdf:RDF/cim:Terminal">
        <UAObject>
          ...
          <References>
            <Reference ReferenceType="Organizes" IsForward="false">ns=2;s=Ts</Reference>
            <Reference ReferenceType="HasTypeDefinition" IsForward="true">ns=2;s=T</Reference>
            <Reference>
      ...
      <xsl:for-each select="rdf:RDF/cim:OperationalLimitType">
        ...
        <xsl:for-each select="rdf:RDF/cim:CurrentLimit">
          <UAObject>
            ...
            <References>
              <Reference ReferenceType="Organizes" IsForward="false">ns=2;s=CLs</Reference>
              <Reference ReferenceType="HasTypeDefinition" IsForward="true">ns=2;s=CL</Reference>
              <Reference>
                <xsl:attribute	name="ReferenceType">ns=2;s=CurrentLimit.OperationalLimitType</xsl:attribute>
                <xsl:attribute name="IsForward">true</xsl:attribute>
                <xsl:sequence select="fn:concat('ns=2;s=', fn:substring(cim:CurrentLimit.OperationalLimitType/@rdf:resource,2,33))"/>
              </Reference>
              <Reference>
                <xsl:attribute	name="ReferenceType">ns=2;s=CurrentLimit.OperationalLimitSet</xsl:attribute>
                <xsl:attribute name="IsForward">true</xsl:attribute>
                <xsl:sequence select="fn:concat('ns=2;s=', fn:substring(cim:CurrentLimit.OperationalLimitSet/@rdf:resource,2,33))"/>
              </Reference>
            </References>
          </UAObject>
          <xsl:call-template name="CreateVariable">
    ...
    <xsl:param name="UAVariableValue"/> 
      ...
      <xsl:attribute name="NodeId" namespace=""  select="fn:concat('ns=2;s=', @rdf:ID, $UAVariableId)"/>
      <xsl:attribute name="BrowseName" namespace="" select="fn:concat('2:', $UAVariableId)"/>
      <xsl:element name="DisplayName">
        <xsl:value-of select="$UAVariableName"/></xsl:element>
      <References>
        <Reference ReferenceType="HasTypeDefinition" IsForward="true">ns=2;s=<xsl:value-of select="$UAVariableName"/></Reference>
        <Reference>
          <xsl:attribute name="ReferenceType">HasProperty</xsl:attribute>
          <xsl:attribute name="IsForward">false</xsl:attribute>
          <xsl:sequence select="fn:concat('ns=2;s=', @rdf:ID)"/>
        </Reference>
      </References>
      <Value>
